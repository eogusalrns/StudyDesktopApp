    ...
    public partial class FrmMember : MetroForm
    {
        ...
        private void DgvData_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1)
            {
                ...
                CmbLevel.Text = selData.Cells[2].Value.ToString();
        ...
        private void SaveData()
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(Helper.Common.ConnString))
                {
                    ...
                    pLevels.Value = CmbLevel.SelectedIndex.ToString();
                    ...
                    var pPasswords = new SqlParameter("@passwords", SqlDbType.VarChar, 20);
        ...
        {
            if ( string.IsNullOrEmpty(TxtNames.Text) || string.IsNullOrEmpty(TxtId.Text) ||
                string.IsNullOrEmpty(TxtAddr.Text) || string.IsNullOrEmpty(TxtEmail.Text)||
                string.IsNullOrEmpty(TxtMobile.Text) || CmbLevel.SelectedIndex == -1 )
            {
        ...
        {
            TxtIdx.Text = TxtNames.Text = TxtId.Text = "";
            TxtMobile.Text = TxtAddr.Text = TxtEmail.Text = TxtPasswords.Text ="";
